...
interface Props {
    ...
    onSaveAnniversary: (campaign: AnniversaryCampaign, shipment: AnniversaryShipment, expectedShipmentId?: string | null) => string | null;
    onDeleteAnniversary: (shipmentId: string) => string | null;
...
export function InventoryPage(props: Props) {
    ...
    {tab === 'anniversaries' && <AnniversaryManagementPanel campaigns={props.anniversaryCampaigns} shipments={props.anniversaryShipments} onSave={props.onSaveAnniversary} onDelete={props.onDeleteAnniversary} onEditingStateChange={onEditingStateChange}/>}
